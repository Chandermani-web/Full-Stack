    ...
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="bg-white p-10 rounded-sm shadow-lg w-96 xl:w-150 flex flex-col">
        <div className="flex flex-col items-center mb-10 leading-0">
          ...
          <p>Sign up to access the clinic management system</p>
        </div>
        ...
        <ToastContainer />
        <p className="text-center mt-4 font-semibold">If you already have an account, please <Link to={"/signin"} className="text-blue-400 font-semibold hover:text-shadow-blue-800 transition duration-300">Sign In</Link>.</p>
      </div>
    </div>
  );
};
